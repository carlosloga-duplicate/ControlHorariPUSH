...
/*              var parameters = $(this).data("url").split("?")[1];;
        ...
        $('#botonGuardarCONFIGURACIO').click(function() {            
            ...
            if(avisaEntrada==1 ) crearNotificacio(50,"2019/25/06",horaEdefecte,"FICHAR","Ficha la entrada !!!");
            
            if(avisaSortida==1 ) crearNotificacio(52,"2019/25/06",horaSdefecte,"FICHAR","Ficha la salida y el tiempo de descanso !!!");
